...
This data cleaning process reduced the number of different storm types from `r n_storm_types_init` to `r n_storm_types_final`.
...
ggsave("harmful_plot.png", width = 16, height = 9)
```
...
```{r, eval=FALSE, include=FALSE}
ggsave("costly_plot.png", width = 16, height = 9)
```
